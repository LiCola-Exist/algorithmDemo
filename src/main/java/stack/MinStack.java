 ...
 *
 * <i>
 * 版本2： 基本思路：以空间换时间，新开最小值辅助栈，每次push都比对出当前两栈栈顶的最小值入最小值栈mins。pop就可以直接pop最小值栈顶 优点：时间复杂度降低，都是O(1)操作栈顶元素。
 * 缺点：空间复杂度高O(n)，可能出现min大量重复情况，如入栈2，1，3，4，5（mins=2，1，1，1，1）
 * </i>
 *
 * <i>
 * 版本3： 基本思路：对版本2进行优化，mins只记录最小值在data栈的索引，避免重复元素。
 * </i>
 *
 * @author LiCola
 * @date 2018/9/28
  ...
  public void push(T value) {
    ...
    if (mins.isEmpty()) {
      ...
      if (min.compareTo(value) > 0) {
        //最小栈 栈顶元素大于value value是新的最小值，记录索引
